...
\title{Distribución y abundancia de gato feral en Isla Robinson Crusoe hasta agosto de 2022}
...
\begin{abstract}
  Hubo hasta \textbf{\VAR{prediction} individuos de gato feral} en Isla Robinson Crusoe en agosto de 2022.
  Las estimaciones de octubre de 2021 a agosto de 2022 oscilaron entre \VAR{min} y \VAR{max} individuos.

\end{abstract}
\selectlanguage{english}
\begin{abstract}
  Up to \textbf{\VAR{prediction} feral cat individuals} were present on Robinson Island in August 2022.
  Estimates from October 2021 to August 2022 ranged from \VAR{min} to \VAR{max} individuals.
\end{abstract}
...
Esos datos incluyen registros desde octubre de 2021 hasta agosto de 2022.
...
This data includes records from October 2021 through August 2022. 
...
\begin{parcolumns}{2}
  ...
  julio 2022.
  La Figura \ref{fig:feral_cat_population_distribution} muestra que la distribución de la
  población es aproximadamente homogénea.
}
  \colchunk[2]{\section*{Results}
  Table \ref{tab:csvEstimacionGatos} shows the size of the population for
  each month from October 2021 to August 2022.
  We ignored the results for August, as we have
  data in only 24\% of the cells.
  The median for the period of October 2021
  to July 2022 was \textbf{70 individuals}. Throughout
  ...
  2022.
  Figure \ref{fig:feral_cat_population_distribution} shows that the distribution of the
  population was approximately homogeneous.
}
\end{parcolumns}
...
\begin{table}[H]
    ...
    \texttt{N} es el número de individuos de gato feral.}{
     ...
     \pgfplotstabletypeset[
       ...
       columns/{.season}/.style={column name={\textbf{Mes}}},
