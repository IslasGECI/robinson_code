...
Los resultados actuales incluyen los datos recibidos el 30 enero de 2023.
}
...
The current results include the data set received on January 30, 2023.
}
\end{parcolumns}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{../data/plot_crusoe_2022-9.png}
