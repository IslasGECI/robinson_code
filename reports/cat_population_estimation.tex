...
We used the package \href{https://github.com/eradicate-dev/eradicate}{\texttt{eradicate}} package developed by David Ramsey\footnotemark[1].
The package \texttt{eradicate} implements N-mixture models for estimating population size ({\href{https://onlinelibrary.wiley.com/doi/10.1111/j.0006-341X.2004.00142.x}{Royle, 2004}}).
...
\begin{figure}[H]
  ...
  \caption{Estimación de la población de gato feral.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{../data/plot_crusoe_2022-7.png}
  \caption{Celdas con datos de cámaras trampa.}
\end{figure}
