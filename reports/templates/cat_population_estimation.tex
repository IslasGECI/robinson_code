...
\title{Distribución y abundancia de gato feral en Isla Robinson Crusoe hasta \VAR{fecha_fin}}
...
\begin{abstract}
  Hubo hasta \textbf{\VAR{prediction} individuos de gato feral} en Isla Robinson Crusoe en \VAR{fecha_fin}.
  Las estimaciones de \VAR{fecha_inicio} a \VAR{fecha_fin} oscilaron entre \VAR{min} y \VAR{max} individuos.

\end{abstract}
\selectlanguage{english}
\begin{abstract}
  Up to \textbf{\VAR{prediction} feral cat individuals} were present on Robinson Island in \VAR{end_date}.
  Estimates from \VAR{start_date} to \VAR{end_date} ranged from \VAR{min} to \VAR{max} individuals.
\end{abstract}
