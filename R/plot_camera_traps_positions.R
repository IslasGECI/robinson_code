...
#' @export
plot_camera_positions_in_square_grid <- function(coordinates_path = "data/raw/robinson_coati_detection_camera_traps/camera_trap_coordinates.csv", camera_sightings_path = "data/Camera-Traps.csv", crusoe_shp_path = "data/spatial/Robinson_Coati_Workzones_Simple.shp", square_grid_path = "data/spatial/Robinson_Coati_1kmGrid_SubsetCameraGrids.shp", plot_output_path) {
