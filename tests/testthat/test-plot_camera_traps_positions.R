describe("Get camera traps positions", {
  it("Hash test for plot_crusoe", {
    ...
    plot_camera_positions_in_square_grid(coordinates_path = coordinates_path, camera_sightings_path = camera_sightings_path, crusoe_shp_path = crusoe_shp_path, square_grid_path = square_grid_path, plot_output_path = plot_output_path)
